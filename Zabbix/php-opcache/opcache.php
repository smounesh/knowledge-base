...
// Zabbix component to fetch PHP OPcache configuration and performance data
// Place this in /var/www/html/opcache.php
// See: /etc/zabbix/zabbix_agentd.conf.d/userparameter_php.conf

// Permit access only from localhost
...
switch($item) {
    ...
    case 'enable':
        ...
        break;
    case 'enable_cli':
        print($configuration['directives']['opcache.enable_cli'] ? 1 : 0);
        break;
    case 'use_cwd':
    ...
    case 'validate_timestamps':
        ...
        break;
    case 'inherited_hack':
        print($configuration['directives']['opcache.inherited_hack'] ? 1 : 0);
        break;
    case 'dups_fix':
    ...
    case 'protect_memory':
        ...
        break;
    case 'save_comments':
        print($configuration['directives']['opcache.save_comments'] ? 1 : 0);
        break;
    case 'load_comments':
        print($configuration['directives']['opcache.load_comments'] ? 1 : 0);
        break;
    case 'fast_shutdown':
        print($configuration['directives']['opcache.fast_shutdown'] ? 1 : 0);
        break;
    ...
    case 'opcache_hit_rate':
        ...
        break;
    default:
        print("ERROR: Unsupported opcache key #$item#");
        exit;
}
?>
